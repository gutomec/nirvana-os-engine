...
```
bun ~/.nirvana/skills/businesses/scripts/brief-business.ts <slug> "<brief>" --project <trace_id>   # business
bun ~/.nirvana/skills/squads/scripts/brief-squad.ts        <slug> "<brief>" --project <trace_id>   # squad
```
