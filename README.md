...
[![version](https://img.shields.io/badge/version-0.1.57--beta-blue)](#license-authorship-and-status)
...
Status: beta (0.x, currently 0.1.57). The engine works today and installs in minutes. Expect the surface to keep moving until 1.0.
