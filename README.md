...
[![version](https://img.shields.io/badge/version-0.1.63--beta-blue)](#license-authorship-and-status)
...
> **Prefer a visual walkthrough?** The [illustrated install guide](https://gutomec.github.io/nirvana-os-engine/) shows every command and its real terminal output, step by step.
