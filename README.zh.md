...
> **看它运行：**[文档主页](https://gutomec.github.io/nirvana-os-engine/)在全部七个运行时中执行同一句话：Claude Code、Codex、Gemini、Antigravity、Grok、Kimi 和 Hermes。
...
> **想要图文教程？** [图解安装指南](https://gutomec.github.io/nirvana-os-engine/install.html) 一步步展示每条命令及其真实的终端输出。
