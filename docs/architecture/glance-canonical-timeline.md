...
- A projeção percorre todos os eventos do Project a cada leitura, como as portas fazem hoje. Um índice por Run fica para o corte que fizer as portas delegarem a `projectMultiTargetRun`.
