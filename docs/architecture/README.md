...
13. [Contrato do avaliador do Gauntlet](gauntlet-evaluator-contract.md)
14. [Política Gauntlet multi-target](gauntlet-multi-target-policy.md)
15. [Coordenador Gauntlet multi-target](gauntlet-multi-target-coordinator.md)
16. [Portas Run Kernel para multi-target](gauntlet-multi-target-run-kernel.md)
17. [Adapters de dispatch para multi-target](gauntlet-multi-target-adapters.md)
18. [Comando multi-target](gauntlet-multi-target-cli.md)
19. [Timeline canônica no Glance](glance-canonical-timeline.md)
20. [Execução no Glance](glance-execution.md)
