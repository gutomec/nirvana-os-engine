...
1. `POST /api/v1/conversations/:cnv/messages` com `mode: "run"` persiste a Message, prepara o Run canônico com `policySnapshotRef: gauntlet-light-canary` e responde `202` quando o Run entrou na fila.
