...
[![version](https://img.shields.io/badge/version-0.1.62--beta-blue)](#licença-autoria-e-status)
...
> **Prefere um passo a passo visual?** O [guia de instalação ilustrado](https://gutomec.github.io/nirvana-os-engine/) mostra cada comando e a saída real do terminal, passo a passo.
