...
[![version](https://img.shields.io/badge/version-0.1.55--beta-blue)](#licencia-autoría-y-estado)
...
Estado: beta (0.x, actualmente 0.1.55). El motor funciona hoy e instala en minutos. Espera que la superficie siga moviéndose hasta 1.0.
