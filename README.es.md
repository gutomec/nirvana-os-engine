...
<p align="center">
  <img src="./docs/assets/nirvana-promo-en-readme.gif" alt="Una orden en prosa — y un conglomerado de IA de empresas, squads y agentes se arma y entrega, con un gate en cada paso" width="100%">
</p>

[![version](https://img.shields.io/badge/version-0.2.0--beta-blue)](#licencia-autoría-y-estado)
...
> **Míralo funcionando:** la [página principal de la documentación](https://gutomec.github.io/nirvana-os-engine/) ejecuta la misma frase dentro de los siete runtimes: Claude Code, Codex, Gemini, Antigravity, Grok, Kimi y Hermes.
...
> **¿Prefieres una guía visual?** La [guía de instalación ilustrada](https://gutomec.github.io/nirvana-os-engine/install.html) muestra cada comando y su salida real de terminal, paso a paso.
