...
const EXCLUDES = [
  ...
  "starter-pack", "tmp", "dist", ".DS_Store", "*.bak.*",
...
const internalDocs = ["docs/plans", "docs/nirvana-evolution", "_private"].filter((d) => existsSync(join(OUT, d)));
...
console.log(`\nOK. Staged at: ${OUT}`);
console.log("Next (push to the PRIVATE engine repo, replacing history):");
