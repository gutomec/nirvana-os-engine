...
if (protocol === "5.0") {
  ...
  // Remediation self-report (fidelity + portability) — problems the
  // schema-validator misses. A "silent failure" becomes a report + a pointer to
  // the fix. It does not fail for this (warn severity; the catalog stays intact).
  try {
