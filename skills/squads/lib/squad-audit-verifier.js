 ...
 *
 * Auth: none. The host CLI is found on PATH and authenticates with its own
 * login — never export CLAUDE_CODE_OAUTH_TOKEN globally to "enable" this (a
 * global export degrades the interactive Claude Code session). Returns
 * verdict "skipped" when no host runtime is on PATH.
 */
