...
`~/.nirvana/skills/_shared/validators/`).
...
4. Validators usam `~/.nirvana/skills/_shared/validators/validators.py`
...
5. Yaml parser embutido em `~/.nirvana/skills/squads/node_modules/yaml`.
...
5. **Adapters em `~/.nirvana/skills/_shared/adapters/` (camada canônica v5)** (claude-code,
