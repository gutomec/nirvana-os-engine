...
| BM25 returns wrong squad (fast mode) | Description too short / examples not aligned | Pad capability description; add 2-3 example phrases in the user's natural language |
