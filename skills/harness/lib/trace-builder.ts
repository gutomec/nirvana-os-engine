...
function summarize(traceId: string, events: Record<string, unknown>[]): TraceTree {
  ...
  for (const sp of spans) {
    ...
    // String vazia não é entidade. Um evento gravado sem contexto trazia
    // `business: ""` e inflava a contagem de businesses/squads em +1, o que
    // aparecia como participante fantasma no resumo do trace.
