...
// Pi Coding Agent — multi-provider (o erro vem do provider ATIVO na sessão),
// então os padrões são o denominador comum das superfícies: OpenAI-style
// insufficient_quota, Google RESOURCE_EXHAUSTED, phrasing de subscription
// (Claude Pro/Max, ChatGPT via OAuth do pi), 429 genérico.
function classifyPi(text: string): QuotaClass {
  // Phrasing real confirmado (xai via pi 0.82.1): 403 "has either used all
