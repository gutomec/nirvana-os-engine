...
//   2 = withheld (deliverables exist; gate FAILED after revisions)
...
export function runDelivery(args: DeliveryArgs): DeliveryResult {
  ...
  const fail = (exitCode: DeliveryExitCode, gateOutcome: DeliveryResult["gateOutcome"], extra: Partial<DeliveryResult> = {}): DeliveryResult => ({
    ...
    revisionsUsed: 0, sessionId, zipPath: null, verifySource: "scan", ...extra,
  });
  ...
  if (gateOutcome === "pass") {
    ...
    return { exitCode: 0, delivered: true, gateOutcome: "pass", produced, gatedFiles, revisionsUsed: revUsed, sessionId, zipPath, verifySource };
  }
  ...
  if (args.forceDeliver) {
    ...
    return { exitCode: 0, delivered: true, gateOutcome: "fail-forced", produced, gatedFiles, revisionsUsed: revUsed, sessionId, zipPath, verifySource };
  }
  ...
  return { exitCode: 2, delivered: false, gateOutcome: "fail", produced, gatedFiles, revisionsUsed: revUsed, sessionId, zipPath: null, verifySource };
}
