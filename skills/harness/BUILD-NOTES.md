...
6. **Adapters/ deixados intencionalmente vazios.** A skill `harness/adapters/` existe mas não duplica os arquivos em `_shared/adapters/`. SKILL.md aponta para `~/.nirvana/skills/_shared/adapters/{claude-code,codex,gemini-cli}.md` como fonte canônica. Decisão: REUSE (DRY) sobre cópia local.
