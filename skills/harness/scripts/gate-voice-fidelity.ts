...
// Clone declarado e ausente da biblioteca não é falha de fidelidade do
// artefato — o agente nunca recebeu esse DNA. Por isso a ausência é anunciada,
// mas nunca vira FAIL. Antes ela sumia dentro de um pacote sem os clones (ou de
// um `null`) e o gate ficava mudo sobre o que faltou.
...
if (pack.deterministic_signals.overall_marker_density < SHORTCIRCUIT_FLOOR) {
  const out = {
    ...
    // Vai junto no JSON para que quem lê o veredito saiba que parte dos clones
    // declarados nem chegou a ser avaliada — e por quê.
