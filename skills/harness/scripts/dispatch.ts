...
if (runtimeDecision.source === "rule") {
...
if (autoMode && routingMode === "fast") {
  ...
  // e não há flag explícita, a sugestão semântica sobrepõe o match BM25.
  if (decision.runtime && !explicitRuntime && runtimeAvailable(decision.runtime)) {
