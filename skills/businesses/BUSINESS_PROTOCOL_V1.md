...
**Schema** (`~/.nirvana/skills/_shared/schemas/core-schemas.json#/definitions/ticket`):
...
Full schemas at `~/.nirvana/skills/businesses/schemas/`:
...
Reference implementation at `~/.nirvana/skills/businesses/templates/example-business/`:
...
*Companion specs: `SQUAD_PROTOCOL_V5.md`, `HARNESS_PROTOCOL_V1.md`. Adapters in `~/.nirvana/skills/businesses/adapters/`. Schemas in `~/.nirvana/skills/businesses/schemas/`. Example template in `~/.nirvana/skills/businesses/templates/example-business/`.*
