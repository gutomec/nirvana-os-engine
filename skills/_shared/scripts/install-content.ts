...
interface SyncRes { added: string[]; updated: string[]; unchanged: string[]; removed: string[]; overwritten: string[]; hashes: Record<string, string>; }
function syncKind(kind: string, srcRoot: string, dstRoot: string, available: string[], old: Record<string, string>): SyncRes {
  ...
  const res: SyncRes = { added: [], updated: [], unchanged: [], removed: [], overwritten: [], hashes: {} };
