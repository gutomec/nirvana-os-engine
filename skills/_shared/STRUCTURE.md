...
|-----------------------------|----------------------------------------------|----------------------------------------------------|---------------------------------|
| Skills (código)             | `~/.nirvana/skills/`                          | `<proj>/.agents/skills/` (+ symlinks)              | `CLAUDE_SKILLS_DIR`             |
...
bun ~/.nirvana/skills/_shared/scripts/init-project.ts ~/Projects/meu-projeto --scope=project
...
```bash
bun ~/.nirvana/skills/_shared/scripts/init-project.ts ~/Projects/cliente-X --scope=merge
