...
import { z } from "zod";
import { CapabilitySchema, JSON_SCHEMA_OPTIONS, SquadManifestSchema, WorkflowSchema } from "../validators/validators.ts";
...
describe("the generator is the source of the files", () => {
  ...
  for (const [file, schema] of [
    ...
    test(`${file} is byte-identical to z.toJSONSchema of its Zod schema`, () => {
      ...
      const generated = z.toJSONSchema(schema, JSON_SCHEMA_OPTIONS) as Record<string, unknown>;
