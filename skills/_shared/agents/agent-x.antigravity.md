...
3. Spawn a fresh `agy` subprocess:
   `agy -p "You are agent-x continuation. Read <project_dir>/HANDOFF.json and continue from the checkpoint. Apply the rules from ~/.claude/skills/_shared/agents/agent-x.antigravity.md." --output-format json`
