...
bun ~/.nirvana/skills/_shared/scripts/init-project.ts <target_dir> --scope=project
...
bun ~/.nirvana/skills/_shared/tests/scope.test.ts
...
} from '~/.nirvana/skills/_shared/validators/validators.ts'
...
Smoke: `bun ~/.nirvana/skills/_shared/validators/validators.ts test` (8 OKs).

### Python / Pydantic v2 (`validators.py`)

```python
from sys import path
path.insert(0, '~/.nirvana/skills/_shared/validators')
...
```bash
# TypeScript
bun ~/.nirvana/skills/_shared/validators/validators.ts test       # 8/8 OK
