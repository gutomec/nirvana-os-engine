...
// Normaliza um model id para o ALIAS (opus/sonnet/haiku/fable) quando é uma
// família Claude conhecida — id completo à prova de versão. Models não-Claude
// (gpt-*, gemini-*, custom) passam intactos. Preferimos o alias porque sobrevive
// a bumps de versão e é o que o `--model` e o settings.json aceitam.
...
// Resolve o model do sistema, SEMPRE como alias quando é família Claude.
// Prioridade:
